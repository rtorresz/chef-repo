...
if [ ! $(which chef-server-ctl) ]; then
  ...
  chef-server-ctl user-create chefadmin Chef Admin admin@visualaimsoft.com temporal877869 --filename /drop/chefadmin.pem
  chef-server-ctl org-create visualaim "VisualAIM, Inc." --association_user chefadmin --filename visualaim-validator.pem
fi
